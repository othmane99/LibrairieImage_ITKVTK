        ...
        void* vtkNotUsed(callData))
    {
        ...
        if (vtkCommand::TimerEvent == eventId)
        {
            ...
            if (this->TimerCount == 1)
            {
                ...
                // Set random angle
                angle1 = dis(gen)+theta; //#include<random>
                // even with the use of dis function it s always in the same direction ??
...
public:
    ...
    std::mt19937 gen{ rd() };
    std::uniform_real_distribution<> dis{ 0.0, 2.0 * 3.14159265359 }; // Random angle
};
...
int main(int, char* [])
{
    ...
    UCharImageType::SizeValueType width{ 215 }, height{ 215 };
    ...
    // Create a white disk using iterartor and index
